    ...
    return (
        <div>
            ...
            <div className="text-center pb-4">
                ...
                <a href="https://www.linkedin.com/in/mahadi-hasan-605b03202/" target="blank" className="social-logo"><img src={linkedin} className="pl-3" alt="" /></a>
                <a href="https://www.facebook.com/profile.php?id=100022929606176" target="blank" className="social-logo"><img src={facebook} className="pl-3" alt="" /></a>
                <a href="https://www.instagram.com/mehedi_hasan_mh_24/" target="blank" className="social-logo"><img src={instagram} className="pl-3" alt="" /></a>
